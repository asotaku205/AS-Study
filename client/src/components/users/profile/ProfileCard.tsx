...
const ProfileCard = ({ avatar, name, username, gmail, docs }: { avatar: string; name: string; username: string; gmail: string; docs: number }) => {
  ...
  return (
    <div className="bg-white/70 dark:bg-slate-900/70 backdrop-blur-xl rounded-2xl border border-white/40 dark:border-slate-800 p-8 text-center shadow-lg">
      ...
      <div className="pt-6 border-t border-slate-200/50 dark:border-slate-700/50 flex flex-col items-center">
        <div>
